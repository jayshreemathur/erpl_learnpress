import 'package:erpl_learnpress/widgets/common_button3.dart';
...
class ViewCorrectScreen extends StatefulWidget {
  const ViewCorrectScreen({Key? key}) : super(key: key);

  @override
  State<ViewCorrectScreen> createState() => _ViewCorrectScreenState();
}

RxInt currentIndex = (-1).obs;

class _ViewCorrectScreenState extends State<ViewCorrectScreen> {
  ...
  final question =
      "Q. 1   It is a long established fact that a reader will distracted by the readable ?";
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              Get.toNamed(MyRouter.failScreen);
            },
            child: Container(
          ...
          Center(
            child: CommonButton('Go to Result', () {
              Get.toNamed(MyRouter.failScreen);
            }, deviceWidth, expended: true, AddSize.size50),
          ),
          InkWell(
            onTap: () {
              Get.toNamed(MyRouter.incorrectResult);
            },
            child: Container(
              width: AddSize.size50,
              height: AddSize.size50,
