...
class SubQuizFirst extends StatefulWidget {
  const SubQuizFirst({Key? key}) : super(key: key);

  @override
  State<SubQuizFirst> createState() => _SubQuizFirstState();
}

RxInt currentIndex = (-1).obs;

class _SubQuizFirstState extends State<SubQuizFirst> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              Get.toNamed(MyRouter.subQuizSecond);
            },
            child: Container(
              width: AddSize.size50,
              height: AddSize.size50,
