...
class ViewIncorrectScreen extends StatefulWidget {
  const ViewIncorrectScreen({Key? key}) : super(key: key);

  @override
  State<ViewIncorrectScreen> createState() => _ViewIncorrectScreenState();
}

RxInt currentIndex = (-1).obs;

class _ViewIncorrectScreenState extends State<ViewIncorrectScreen> {
